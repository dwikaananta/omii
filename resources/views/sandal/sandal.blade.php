...
@section('content')
    ...
    <div class="text-right mb-3">
        <a href="/sandal/create" class="btn btn-primary px-3">Tambah Data</a>
    </div>
            ...
            @foreach ($sandal as $i)
                <tr>
                    ...
                    <td class="text-center">
                        <form class="btn-group" method="POST" action="/sandal/{{ $i->id }}">
                            @csrf
                            @method('DELETE')
                            <a href="/sandal/{{ $i->id }}/edit" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
