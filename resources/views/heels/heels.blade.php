...
@section('content')
    ...
    <div class="text-right mb-3">
        <a href="/heels/create" class="btn btn-primary px-3">Tambah Data</a>
    </div>
            ...
            @foreach ($heels as $i)
                <tr>
                    ...
                    <td class="text-center">
                        <form class="btn-group" method="POST" action="/heels/{{ $i->id }}">
                            @csrf
                            @method('DELETE')
                            <a href="/heels/{{ $i->id }}/edit" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
